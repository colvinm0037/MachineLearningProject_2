...
public class KColors {
	...
	public static void runKColors() {
		System.out.println("Running K Colors tests");
		
		int N = 50; // number of vertices
		int L = 4; // L adjacent nodes per vertex
		int K = 8; // K possible colors
	...
	private void trainIterations(OptimizationAlgorithm opt) {
